...
public class RefundRequest implements Serializable {
	...
	public RefundRequest(String ordersNo, String refundTitle, String refundContent)
	{
		super();
	...
	{
		return "RefundRequest [ordersNo=" + ordersNo + ", refundTitle=" + refundTitle + ", refundContent="
				+ refundContent + "]";
	}
}
